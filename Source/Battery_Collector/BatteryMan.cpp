...
void ABatteryMan::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ABatteryMan::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ABatteryMan::Look);
...
void ABatteryMan::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ABatteryMan::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
